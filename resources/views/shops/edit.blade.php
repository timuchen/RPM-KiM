                        ...
                        <div class="col-sm-8 offset-sm-2">
                            ...
                            <form method="post" action="{{ route('shops.update', $shop->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$shop->description}}" name="description"/>
                                </div>
                                <div class="form-group">
                                    <label for="sity">Город:</label>
                                    <input type="text" class="form-control" value="{{$shop->sity}}" name="sity"/>
                                </div>
                                <div class="form-group">
                                    <label for="adress">Адрес:</label>
                                    <input type="text" class="form-control" value="{{$shop->adress}}" name="adress"/>
                                </div>

...
<head>
    ...
    <title>RPM - КиМ React Price Monitoring</title>
                ...
                <div class="collapse navbar-collapse col-10" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                          ...
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/shops/create">Добавить</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="/shops">Список магазинов</a>
                            </div>
                          </li>
                          <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/manufacturers/create">Добавить</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="/manufacturers">Список производителей</a>
                            </div>
                          </li>
                          <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/brands/create">Добавить</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="/brands">Список брендов</a>
                            </div>
                          </li>
                          <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="/products/create">Добавить</a>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="/products">Товарные позиции</a>
                            </div>
                          </li>
                    </ul>
